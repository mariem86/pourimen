...
// add annonce
router.post('/addannonce',isAuthenticate,isAuthorize(['client','artisan',false]), (req,res)=>{
...
router.delete("/deleteannonceartisan/:_id",isAuthenticate,isAuthorize(['client','artisan','admin',false]),(req,res)=>{
